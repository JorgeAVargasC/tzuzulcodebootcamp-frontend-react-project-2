	...
	return (
		<nav className="">
            <ul className="hidden md:flex items-center space-x-4">
                <li><NavLink to={"/"} className="py-4 px-2 text-orange-500 border-b-4 border-orange-500 font-semibold">Home</NavLink></li>
                <li><NavLink to={"/contact"} className="py-4 px-2 text-gray-500 font-semibold hover:text-orange-500 transition duration-300">Contact Us</NavLink></li>
                {!logged ? 
                <>   
                ...
                <>
                    <li><NavLink to={"/shop"} className="py-4 px-2 text-gray-500 font-semibold hover:text-orange-500 transition duration-300">Shop</NavLink></li>
